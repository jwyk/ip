...
/**
 * Represents a storage class which saves in the following format taskIcon|description|isDone
 *
 * <p>For Deadline tasks, the following is the format taskIcon|description|isDone|dueDate
 *
 * <p>For Event tasks, the following is the format taskIcon|description|isDone|startDate|endDate
 */
        ...
        try {
            for (Task temp : list.taskList) {
                ...
                if (temp instanceof Todo) {
                    fw.write("T" + DIV + temp.getStatus() + DIV + temp.getDescription() + DIV);
        ...
        while (scanner.hasNext()) {
            ...
            case "T":
                ...
                if (temp[1].equals("true")) {
                    ...
                    break;
                case "D":
                    Deadline tempDeadline = new Deadline(temp[2], LocalDateTime.parse(temp[3]));
                    if (temp[1].equals("true")) {
